...
## Why These Patterns?
The AMLSim dataset contains ground-truth labels for fan-in and cycle patterns. These are real, operationally significant AML typologies that  banks actively monitor for.
